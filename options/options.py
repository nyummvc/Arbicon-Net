...
class ArgumentParser():
    ...
    def add_train_parameters(self):
        ...
        train_params.add_argument('--lr2', type=float, default=0.001, help='learning rate of geotransnet')
        ...
        train_params.add_argument('--train-gd', type=str_to_bool, nargs='?', const=True, default=True, help='Train grid deformation')
    ...
    def add_cnn_model_parameters(self):
        ...
        model_params.add_argument('--fr-feature-size-two', type=int, default=15, help='image input size')
        model_params.add_argument('--fr-kernel-sizes-two', nargs='+', type=int, default=[7,5], help='kernels sizes in feat. reg. 2D conv layers')
        model_params.add_argument('--fr-channels-two', nargs='+', type=int, default=[128,64], help='channels in feat. reg. 2D conv layers')
        model_params.add_argument('--fr-feature-size-four', type=int, default=15, help='image input size')
        model_params.add_argument('--fr-kernel-sizes-four', nargs='+', type=int, default=[3,3,3], help='kernels sizes in feat. reg. 4D conv layers')
        model_params.add_argument('--fr-channels-four', nargs='+', type=int, default=[10,10,1], help='channels in feat. reg. 4D conv layers')
